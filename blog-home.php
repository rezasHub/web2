				...
				<div class="banner-content col-lg-5">
					...
					<div class="breadcrmb">
						<p>
							...
							<a href="submit.html">فرم ثبت نام</a>
						</p>
					</div>
				</div>
			</div>
...
<!-- Start top-category-widget Area -->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg"></div>							<a href="card.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/blog/cat-widget1.jpg" alt="">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">انواع عضویت</h4>
									<span></span>
									<p>آشنایی بیشتر با انواع عضویت</p>
								</div>
							</a>
						</div>
					</div>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg"></div>							<a href="khed.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/blog/cat-widget2.jpg" alt="">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">خدمات ما</h4>
									<span></span>
									<p>آشنایی بیشتر با خدمات ما</p>
								</div>
							</a>
						</div>
					</div>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg"></div>							<a href="faq.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/blog/cat-widget3.jpg" alt="">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">پشتیبانی</h4>
									<span></span>
									<p>سوالات متداول</p>
								</div>
							</a>
					...
					<div class="single-post row">
						<div class="col-lg-3 col-md-3 meta-details">
							...
							<div class="user-details row">
								<p class="user-name col-lg-12 col-md-12 col-6"> <span class="lnr lnr-user"></span></p>
								<p class="date col-lg-12 col-md-12 col-6"> <span class="lnr lnr-calendar-full"></span></p>
								<p class="view col-lg-12 col-md-12 col-6"><span class="lnr lnr-eye"></span></p>
							</div>
						</div>
						<div class="col-lg-9 col-md-9">
												<div class="comment-form">
						<h2>تایید اطلاعات(پیش فاکتور)</h2>
													<br> 
													<br> 
					<?php 
	...
	<tr>
		...
		<td>	<?php 
			if($noe=='50000') echo("طلایی");
			else {
				if($noe=='30000') echo("نقره ای");
				else{
					if($noe=='20000') echo("برنزی");
					else echo("سبز");
				}
			}
			?>	</td>
		...
		<td><?php echo($noe); ?>  تومان </td>
		</tr>	
	
	
	</table>
			هزینه ی صدور و ارسال کارت عضویت جداگانه محاسبه و دریافت میگردد
			<br>
			<br>
<?php
...
{
$sql="insert into psubmit(nam,lnam,shen,email,pass,sal,tel,noe) values ('$nam','$lnam','$shen','$email','$shen','$sal','$tel','$noe')";


if($con->query($sql)==TRUE)
	echo('<a href="req.php" class="primary-btn">پرداخت و ثبت نهایی </a>');
else 
	echo('طبق استعلام از مراجع اطلاعات وارد شده، صحیح نمی باشد <br><a href="submit.html" class="primary-btn">اصلاح اطلاعات وارد شده</a>');
			...
			<div class="col-lg-4 sidebar-widgets">
					<div class="widget-wrap">
						<div class="single-sidebar-widget user-info-widget">
							...
							<p>
								<center>	<h3>پیرامون ثبت نام</h3></center>
							<p class="excert">
				<center>
								الف - حتما قوانین سایت و قوانین رقابت رو مطالعه کنید 
				<br> 
				<a href="ganon.html" class="button">برای مطالعه قوانین سایت کلیک کنید</a>
					<br> 
					<a href="ganoon.html" class="button">برای مطالعه قوانین رقابت کلیک کنید</a>
								<br>
								ب - حتما خدمات ما و انواع عضویت رو مطالعه کنید 
								<br>
								<a href="khed.html" class="button">برای مطالعه خدمات ما کلیک کنید </a>
								<br>
								<a href="card.html" class="button">برای مشاهده انواع عضویت کلیک کنید</a>
							</center></p>
							</p>
						</div>
					</div>
