			...
			<div class="row">
				<div class="col-lg-8 posts-list">
					...
					<div class="single-post row">
						...
						<h2>به خانواده بزرگ نخبه ایرانی خوش آمدید</h2>
													<br> 
													<br> 
					<?php 
...
{
$sql="insert into submit(nam,lnam,shen,email,pass,sal,tel,noe) values ('$nam','$lnam','$shen','$email','$shen','$sal','$tel','$noe')";


if($con->query($sql)==TRUE)
	echo('<button class="primary-btn">ثبت نام شما با موفقیت انجام شد</button>');
else 
	echo('<button class="primary-btn">ثبت نام شما دچار مشکل شد !! <br> سریعا با پشتیبانی تماس حاصل فرمایید</button>');
